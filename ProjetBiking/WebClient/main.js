...
function searchCoordinates() {
    ...
    var url = "http://localhost:8734/Design_Time_Addresses/RoutingWithBikes/Service1/rest/GetItinaries/startAddress="+address
...
function searchAddress() {
    let address = encodeURI(document.getElementById("adress").value)
